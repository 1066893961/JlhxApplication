...
import com.jlhx.payroll.application.utils.ParamsUtils;
...
public class HttpHelper {
     ...
     * @param callback 回调
     */
    public static void getIsCollect(Object tag, JsonCallback callback) {
        OkGo.get("http://192.168.1.103/alipay/agreement/userAgreementPageSign?user_name=黄峥&cert_no=350600197604041589&company_id=3")
                .tag(tag)
                .execute(callback);
    }
