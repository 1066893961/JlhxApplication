...
import com.jlhx.apollp.application.manager.ActivityCollector;
import com.jlhx.apollp.application.utils.CreateViewUtil;
import com.jlhx.apollp.application.utils.LogUtil;
import com.jlhx.apollp.application.views.immersionbarview.ImmersionBar;
...
//            EventBus.getDefault().register(this);
     ...
     * initToobar之后才能调用
     */
    protected void changeLeftButtonText(){
        mLeftRl.removeAllViews();
        mLeftRl.addView(CreateViewUtil.getToolbarLeftTextButton(mActivity));
    }
     ...
     * @param enable
     */
    protected void rightButtonEnable(boolean enable){
//        mRightRl.setEnabled(enable);
        if (mRightRl != null && mRightRl.getChildCount()>0) {
            View childAt = mRightRl.getChildAt(0);
            if(childAt != null){
